...
class MazePath {
  ...
  createDestNode(edge) {
    ...
    if (edge.direction === "down") {
      node = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](sourceRow + 2, sourceCol);
      node.children.up = true;
    } else if (edge.direction === "up") {
      node = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](sourceRow - 2, sourceCol);
      node.children.down = true;
    } else if (edge.direction === "left") {
      node = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](sourceRow, sourceCol - 2);
  ...
  markGrid(sourceNode, direction, destNode) {
  ...
  generateMaze(tree, ctx) {
    for (let i = 0; i < tree.length; i++) {
      ...
      if (this.grid[sourceRow][sourceCol] === null) {
        let sourceNode = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](sourceRow, sourceCol);
        this.grid[sourceRow][sourceCol] = sourceNode;
        this.markGrid(sourceNode, direction, destNode);
      } else {
