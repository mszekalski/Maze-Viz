...
class Board {
  constructor(ctx, size) {
    ...
    console.log(new _maze_path__WEBPACK_IMPORTED_MODULE_2__["default"](this.tree, this.size * 2));
  }
  ...
  generateMaze(size, tree) {
    ...
    for (let i = 0; i < tree.length; i++) {
      ...
      if (path[sourceRow][sourceCol] === null) {
        let node = new _node__WEBPACK_IMPORTED_MODULE_0__["default"](null, null, null, null, sourceRow, sourceCol);
