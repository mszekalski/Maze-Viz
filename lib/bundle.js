...
class MazePath {
  ...
  markGrid(sourceNode, direction) {
    ...
    if (direction === "down") {
      let destNode = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](row + 2, col);
      ...
      let destNode = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](row, col + 2);
  ...
  generateMaze(tree, ctx) {
    for (let i = 0; i < tree.length; i++) {
      ...
      if (sourceNode === null) {
        sourceNode = new _maze_node__WEBPACK_IMPORTED_MODULE_0__["default"](sourceRow, sourceCol);
